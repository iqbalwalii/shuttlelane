			...
			<Grid container justify='center' spacing={3}>
				...
				<Grid item xs={11} sm={7}>
					...
					<Typography variant='body1' paragraph color='textSecondary'>
						...
						holiday car with Shuttlelane won’t cost you an arm. Our
						car hire service covers both short and long trips. We
						prioritize your satisfaction above other things and as
						such, we provide you with the most favourable car hire
						deals.
					</Typography>
					<Typography variant='body1' paragraph color='textSecondary'>
						You only need to search through our collection, make a
						choice of car, reach us to book and you are on your way
						to fulfilling that family vacation.
					</Typography>
					<Typography variant='body1' paragraph color='textSecondary'>
						Shuttlelane is a reality maker. We make vacation dreams
						become realities with functional safety guaranteed car
						hire service.
					</Typography>
					<Typography variant='body1' paragraph color='textSecondary'>

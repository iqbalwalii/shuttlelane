...
export default function TransitionsModal(props) {
  ...
  return (
    <div>
      ...
      >
        <Fade in={props.open} style={{background:'#362e8b', borderTopRightRadius:'30px',  borderBottomLeftRadius:'30px',width:'40%', border:'none',  }}>
            ...
            <form className={modal.modalForm}>
              ...
              {/* <div className={modal.inputFields}> */}
                <select name="" id="" required >
                          <option value="" selected disabled value='null' id="null">Cabin Classes </option>
